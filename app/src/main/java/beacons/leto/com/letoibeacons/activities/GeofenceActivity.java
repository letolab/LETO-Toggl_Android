...
import beacons.leto.com.letoibeacons.geofence.GeofenceTransitionsIntentService;
 ...
 * becomes available.
 */
public class GeofenceActivity extends AppCompatActivity implements ConnectionCallbacks, OnConnectionFailedListener, ResultCallback<Status> {
    ...
    boolean isWaitingToRemove = false;
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if (isWaitingToRemove){
            isWaitingToRemove=false;
            removeGeofences();
        }
    }
